...
TEST_F(TEST_6502, LDA_Circular)
{
   ...
   mem_.set(0xFF01, 0x54); 

   mem_.set(0xFF02, CPU::INS_STA_ABS);
   mem_.set(0xFF03, 0x10); 
   mem_.set(0xFF04, 0x20); 

   mem_.set(0xFF05, CPU::INS_LDX_ABS);
   mem_.set(0xFF06, 0x10);
   mem_.set(0xFF07, 0x20);

...
TEST_F(TEST_6502, TAX_simple)
{
   ...
   mem_.set(0xFF01, 0x0069);  
   mem_.set(0xFF02, CPU::INS_TAX);  
...
{
   cpu_.Reset(mem_, 0xFF00);
   mem_.set(0xFF00, CPU::INS_LDX_IM);  
   mem_.set(0xFF01, 0x0069);  
   mem_.set(0xFF02, CPU::INS_TXA);  
   mem_.set(0xFF03, CPU::INS_NOTHING);  
...
{
   cpu_.Reset(mem_, 0xFF00);
   mem_.set(0xFF00, CPU::INS_LDY_IM);  
   mem_.set(0xFF01, 0x0069);  
   mem_.set(0xFF02, CPU::INS_TYA);  
   mem_.set(0xFF03, CPU::INS_NOTHING);  

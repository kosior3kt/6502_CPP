...
TEST_F(TEST_6502, DEC_ZP_simple)
{
   ...
   mem_.set(MEM_ADDR, 0x6A);
   mem_.set(0xFFFC, CPU::INS_DEC_ZP);
...
TEST_F(TEST_6502, DEC_ZPX_simple)
{
   ...
   cpu_.X        = 0x01;
   mem_.set(MEM_ADDR + cpu_.X, 0x6A);
   mem_.set(0xFFFC, CPU::INS_DEC_ZPX);
   mem_.set(0xFFFD, MEM_ADDR);
   auto cyclesLeft = cpu_.execute(5, mem_);
...
TEST_F(TEST_6502, DEC_ABS_simple)
{
   ...
   mem_.set(MEM_ADDR, 0x6A);
   mem_.set(0xFFFC, CPU::INS_DEC_ABS);

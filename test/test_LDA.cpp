...
{
   mem_.set(0xFFFC, CPU::INS_LDA_IM);
   mem_.set(
       0xFFFD, 0b10000000
...
{
   mem_.set(0xFFFC, CPU::INS_LDA_ZP);
...
{
   cpu_.X = 0x5;
   mem_.set(0xFFFC, CPU::INS_LDA_ZPX);
   mem_.set(0xFFFD, 0x42);
...
{
   mem_.set(0xFFFC, CPU::INS_LDA_ABS);
   mem_.set(0xFFFD, 0x80);
...
{
   cpu_.X = 0x0001;
   mem_.set(0xFFFC, CPU::INS_LDA_ABSX);
   mem_.set(0xFFFD, 0x80);
...
{
   cpu_.Y = 0x0001;
   mem_.set(0xFFFC, CPU::INS_LDA_ABSY);
   mem_.set(0xFFFD, 0x80);
   mem_.set(0xFFFE, 0x69); /// 0x6980 + 0x0001 = 0x6981
   mem_.set(0x6981, 0x69);
   auto cyclesLeft = cpu_.execute(4, mem_);
...
{  
   cpu_.Y = 0x01;
   mem_.set(0xFFFC, CPU::INS_LDA_INDY);
   mem_.set(0xFFFD, 0x004);
   mem_.set(0x0004, 0x10); /// looking first at the original location
   mem_.set(0x0005, 0x05); /// now we need to add Y to the lower byte
   mem_.set(0x0511, 0x69); /// 0x05 ++ (0x10 + 0x01) = 0x0511  , or is it other way around?
...
{  
   cpu_.Y = 0xFF;
   mem_.set(0xFFFC, CPU::INS_LDA_INDY);
   mem_.set(0xFFFD, 0x04);
   mem_.set(0x0004, 0x01); /// looking first at the original location and add it to Y => 0xFF + 0x01 = 0x100 + additional cycle
   mem_.set(0x0005, 0x01); /// now higher byte => 0x0100 + 0x01 (high) = 0x0200
   mem_.set(0x0200, 0x69); /// 
...
{  
   ...
   cpu_.X = 0x02;
   mem_.set(0xFFFC, CPU::INS_LDA_INDX);
   mem_.set(0xFFFD, 0x004);
   mem_.set(0x0006, 0x10); /// 0x02 + 0x04 = 0x06
   mem_.set(0x0007, 0x05); ///we take 2 bits from there and sum up the result
   mem_.set(0x0510, 0x69); 
